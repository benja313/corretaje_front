<template>
  <div>
    <div class="wrapper">
      ...
      >
        <h1 class="tim-note text-info">Administración Publicaciones</h1>
      </parallax>
      <div class="main main-raised">
        <div class="section">
          <div class="container">
            
            <md-table v-model="publicaciones" md-sort="titulo" md-sort-order="asc" md-card md-fixed-header>
              <md-table-empty-state
                md-label="No existen elementos"
                md-description="Puedes crear nuevas publicaciones para el sistema"
              ></md-table-empty-state>
              ...
              <md-table-row slot="md-table-row" slot-scope="{ item }">
                ...
                <md-table-cell v-if="item.id_estado === 4" md-label="Desactivar" >
                  <md-button  class="md-warning disabled">Desactivar</md-button>
                </md-table-cell>
